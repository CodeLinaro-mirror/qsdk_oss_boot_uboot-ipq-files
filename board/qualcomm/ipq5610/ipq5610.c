...
#define MACH_TYPE_IPQ5610_EMULATION		0xF050000

struct dts_fixup ipq5610_mmc_fixup [] = {
...
struct dts_fixup *mmc_fixup = ipq5610_mmc_fixup;

struct dts_fixup ipq5610_usb_fixup [] = {
...
struct dts_fixup *usb_fixup = ipq5610_usb_fixup;
...
struct node_info ipq_fnodes[] = {
	...
	{ "qcom,ipq5610-nand", MTD_DEV_TYPE_NAND},
};
...
struct multidtb_config ipq5610_dtb_info = {
	.list = machid_dts,
	.ncount = ARRAY_SIZE(machid_dts),
	.index = 0,
};

struct multidtb_config *g_board_dtb_info = &ipq5610_dtb_info;
