...
/* CBCR Control Bits - Already defined in header, removed duplicates */
...
/*
 * IPQ5210 Clock Arrays
 */
#if defined(CONFIG_TARGET_IPQ5210)
static const unsigned long ipq5210_ena_vote_clocks[] = {
	/* GCC Clocks */
	GCC_APCS_CLOCK_BRANCH_ENA_VOTE,
};

static const unsigned long ipq5210_all_cbcr_clocks[] = {
	/* GCC Clocks */
	GCC_ADSS_PWM_CBCR,
	GCC_AHB_CBCR,
	GCC_APSS_AHB_CBCR,
...
#endif /* CONFIG_TARGET_IPQ5210 */

/*
 * IPQ9650 (Juhu) Clock Arrays
 */
#if defined(CONFIG_TARGET_IPQ9650)
static const unsigned long ipq9650_ena_vote_clocks[] = {
	/* GCC Clocks */
	GCC_APCS_CLOCK_BRANCH_ENA_VOTE,
};

static const unsigned long ipq9650_all_cbcr_clocks[] = {
	/* GCC Clocks */
	GCC_ADSS_PWM_CBCR,
	GCC_AHB_CBCR,
	...
	GCC_DDRSS_SMS_SLOW_CBCR,
	GCC_GEMNOC_AHB_CBCR,
	GCC_GEMNOC_ANOC_CBCR,
	GCC_GEMNOC_ANOC_PCIE_CBCR,
	GCC_GEMNOC_APSS_CBCR,
	GCC_GEMNOC_CNOC_CBCR,
	GCC_GEMNOC_NSSNOC_CBCR,
	GCC_GEMNOC_QOSGEN_EXTREF_CBCR,
	...
	GCC_PCIE2_AHB_CBCR,
	GCC_PCIE2_AUX_CBCR,
	GCC_PCIE2_AXI_M_CBCR,
	GCC_PCIE2_AXI_S_BRIDGE_CBCR,
	GCC_PCIE2_AXI_S_CBCR,
	//GCC_PCIE2_PIPE_CBCR,
	GCC_PCIE3_AHB_CBCR,
	GCC_PCIE3_AUX_CBCR,
	GCC_PCIE3_AXI_M_CBCR,
	GCC_PCIE3_AXI_S_BRIDGE_CBCR,
	GCC_PCIE3_AXI_S_CBCR,
	//GCC_PCIE3_PIPE_CBCR,
	GCC_PCIE4_AHB_CBCR,
	GCC_PCIE4_AUX_CBCR,
	GCC_PCIE4_AXI_M_CBCR,
	GCC_PCIE4_AXI_S_BRIDGE_CBCR,
	GCC_PCIE4_AXI_S_CBCR,
	//GCC_PCIE4_PIPE_CBCR,
	GCC_PCIE_CMN_HCLK_CBCR,
	GCC_PCIE_CMN_LDO_CBCR,
	GCC_PCNOC_AHB_CBCR,
	GCC_PCNOC_AT_CBCR,
	GCC_PCNOC_BUS_TIMEOUT0_AHB_CBCR,
	GCC_PCNOC_BUS_TIMEOUT1_AHB_CBCR,
	...
	GCC_QUPV3_WRAP_SE4_CBCR,
	GCC_QUPV3_WRAP_SE5_CBCR,
	GCC_QUPV3_WRAP_SE6_CBCR,
	GCC_QUPV3_WRAP_SE7_CBCR,
	GCC_RBCPR_AHB_CBCR,
	GCC_RBCPR_CBCR,
	GCC_REFGEN_CMN_UPHY_CORE_CBCR,
	GCC_REFGEN_CMN_UPHY_HCLK_CBCR,
	GCC_REFGEN_PCIE_CORE_CBCR,
	GCC_REFGEN_PCIE_HCLK_CBCR,
	GCC_SDCC1_AHB_CBCR,
	GCC_SDCC1_APPS_CBCR,
	GCC_SDCC1_ICE_CORE_CBCR,
	GCC_SMMU_CFG_CBCR,
	...
	GCC_SPDM_PCNOC_CY_CBCR,
	GCC_SPDM_SNOC_CY_CBCR,
	GCC_SYS_CE_EDPD_CBCR,
	GCC_SYS_NOC_AT_CBCR,
	GCC_SYS_NOC_AXI_CBCR,
	GCC_TCSR_AHB_CBCR,
	GCC_THROTTLE_XO_CBCR,
	//GCC_TIC_CBCR,
	GCC_TLMM_AHB_CBCR,
	GCC_TLMM_CBCR,
	GCC_TSENS_AOSS_CBCR,
	...
	GCC_USB1_MOCK_UTMI_CBCR,
	GCC_USB1_PHY_CFG_AHB_CBCR,
	GCC_USB1_SLEEP_CBCR,
	GCC_USB_CMN_HCLK_CBCR,
	GCC_USB_CMN_LDO_CBCR,
	GCC_XO_CBCR,
	GCC_XO_DIV4_CBCR,

#if 0
	/* TME and SEC_CTRL clocks - not needed for IPQ9650 */
	...
	/* Other disabled clocks */
	GCC_AGGRNOC_ATB_CBCR,
	GCC_AGGRNOC_TS_CBCR,
	GCC_ANOC0_AXI_CBCR,
	GCC_ANOC1_AXI_CBCR,
	GCC_ANOC_PCIE0_1LANE_M_CBCR,
	GCC_ANOC_PCIE0_1LANE_S_CBCR,
	GCC_ANOC_PCIE1_2LANE_M_CBCR,
	GCC_ANOC_PCIE1_2LANE_S_CBCR,
	GCC_ANOC_PCIE2_2LANE_M_CBCR,
	GCC_ANOC_PCIE2_2LANE_S_CBCR,
	GCC_ANOC_PCIE3_2LANE_M_CBCR,
	GCC_ANOC_PCIE3_2LANE_S_CBCR,
	GCC_ANOC_PCIE4_1LANE_M_CBCR,
	GCC_ANOC_PCIE4_1LANE_S_CBCR,
	GCC_ANOC_PCNOC_AHB_CBCR,
	GCC_ANOC_QOSGEN_EXTREF_CBCR,
	GCC_ANOC_XO_DBG_CBCR,
	GCC_ANOC_XO_DCD_CBCR,
	GCC_CNOC_PRIMESS_AHBS_CBCR,
	GCC_CNOC_TURING_AHBS_CBCR,
	GCC_PRIMESS_AHBM_CBCR,
	GCC_PRIMESS_AHBM_PARTIAL_CBCR,
	GCC_PRIMESS_AHBS_CBCR,
	GCC_PRIMESS_ATB_CBCR,
	GCC_PRIMESS_AXIM_CBCR,
	GCC_PRIMESS_AXIM_PARTIAL_CBCR,
	GCC_PRIMESS_CBCR,
	GCC_PRIMESS_XO_CBCR,
	GCC_Q6SS_TSCTR_1TO2_CBCR,
	GCC_QMIP_CORE_CBCR,
	GCC_SNOC_PRIMESS_AXIM_CBCR,
	GCC_TURING_AHBS_CBCR,
	GCC_TURING_ATBM_AT_CBCR,
	GCC_TURING_CXO_CBCR,
	GCC_TURING_EPCB_RX_CBCR,
	GCC_TURING_GEMNOC_CBCR,
	GCC_TURING_PCLK_DBG_CBCR,
	GCC_TURING_Q6SS_TRIG_CBCR,
	GCC_TURING_Q6_AXIM_DIV_CBCR,
#if 0
	/* APCS Clocks */
 ...
 */
typedef struct {
	uintptr_t cmd_rcgr;   /* CMD_RCGR register offset */
	uintptr_t cfg_rcgr;   /* CFG_RCGR register offset */
	uintptr_t m_reg;      /* M register offset (0 if not used) */
	uintptr_t n_reg;      /* N register offset (0 if not used) */
	uintptr_t d_reg;      /* D register offset (0 if not used) */
...
/*
 * IPQ5210 RCGR Configuration Table
 */
#if defined(CONFIG_TARGET_IPQ5210)
static const rcgr_config_entry_t ipq5210_rcgr_configs[] = {
	/* QUPV3 Clocks */
...
/*
 * IPQ9650 (Juhu) RCGR Configuration Table
 */
#if defined(CONFIG_TARGET_IPQ9650)
static const rcgr_config_entry_t ipq9650_rcgr_configs[] = {
	/* QUPV3 Clocks */
	{GCC_QUPV3_2X_CORE_CMD_RCGR, GCC_QUPV3_2X_CORE_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 8, 0, 0, 0},
	{GCC_QUPV3_WRAP_SE0_CMD_RCGR, GCC_QUPV3_WRAP_SE0_CFG_RCGR,
	 GCC_QUPV3_WRAP_SE0_M, GCC_QUPV3_WRAP_SE0_N, GCC_QUPV3_WRAP_SE0_D,
	 SRC_GPLL0, 25, 0, 0, 0},
	{GCC_QUPV3_WRAP_SE1_CMD_RCGR, GCC_QUPV3_WRAP_SE1_CFG_RCGR,
	 GCC_QUPV3_WRAP_SE1_M, GCC_QUPV3_WRAP_SE1_N, GCC_QUPV3_WRAP_SE1_D,
	 SRC_GPLL0, 25, 0, 0, 0},
	{GCC_QUPV3_WRAP_SE2_CMD_RCGR, GCC_QUPV3_WRAP_SE2_CFG_RCGR,
	 GCC_QUPV3_WRAP_SE2_M, GCC_QUPV3_WRAP_SE2_N, GCC_QUPV3_WRAP_SE2_D,
	 SRC_GPLL0, 25, 0, 0, 0},
	{GCC_QUPV3_WRAP_SE3_CMD_RCGR, GCC_QUPV3_WRAP_SE3_CFG_RCGR,
	 GCC_QUPV3_WRAP_SE3_M, GCC_QUPV3_WRAP_SE3_N, GCC_QUPV3_WRAP_SE3_D,
	 SRC_GPLL0, 25, 0, 0, 0},
	...
	// SRC_GPLL0, 25, 0, 0, 0},
	{GCC_QUPV3_WRAP_SE7_CMD_RCGR, GCC_QUPV3_WRAP_SE7_CFG_RCGR,
	 GCC_QUPV3_WRAP_SE7_M, GCC_QUPV3_WRAP_SE7_N, GCC_QUPV3_WRAP_SE7_D,
	 SRC_GPLL0, 25, 0, 0, 0},

	/* GP Clocks */
	{GCC_GP1_CMD_RCGR, GCC_GP1_CFG_RCGR,
	 GCC_GP1_M, GCC_GP1_N, GCC_GP1_D, SRC_GPLL0, 8, 0, 0, 0},
	{GCC_GP2_CMD_RCGR, GCC_GP2_CFG_RCGR,
	 GCC_GP2_M, GCC_GP2_N, GCC_GP2_D, SRC_GPLL0, 8, 0, 0, 0},
	{GCC_GP3_CMD_RCGR, GCC_GP3_CFG_RCGR,
	 GCC_GP3_M, GCC_GP3_N, GCC_GP3_D, SRC_GPLL0, 8, 0, 0, 0},

	/* APSS Clocks */
	{GCC_APSS_AXI_CMD_RCGR, GCC_APSS_AXI_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 2, 0, 0, 0},
	{GCC_APSS_AHB_CMD_RCGR, GCC_APSS_AHB_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},
	{GCC_APSS_TCU_CMD_RCGR, GCC_APSS_TCU_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 4, 0, 0, 0},
	...
	/* PCIe Clocks */
	{GCC_PCIE_AUX_CMD_RCGR, GCC_PCIE_AUX_CFG_RCGR,
	 GCC_PCIE_AUX_M, GCC_PCIE_AUX_N, GCC_PCIE_AUX_D, SRC_GPLL0, 20, 1, 4, 8},
	{GCC_PCIE0_AXI_M_CMD_RCGR, GCC_PCIE0_AXI_M_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 12, 0, 0, 0},
	{GCC_PCIE0_AXI_S_CMD_RCGR, GCC_PCIE0_AXI_S_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 12, 0, 0, 0},
	{GCC_PCIE0_RCHNG_CMD_RCGR, GCC_PCIE0_RCHNG_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},
	{GCC_PCIE1_AXI_M_CMD_RCGR, GCC_PCIE1_AXI_M_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 9, 0, 0, 0},
	{GCC_PCIE1_AXI_S_CMD_RCGR, GCC_PCIE1_AXI_S_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 12, 0, 0, 0},
	{GCC_PCIE1_RCHNG_CMD_RCGR, GCC_PCIE1_RCHNG_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},
	{GCC_PCIE2_AXI_M_CMD_RCGR, GCC_PCIE2_AXI_M_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 9, 0, 0, 0},
	{GCC_PCIE2_AXI_S_CMD_RCGR, GCC_PCIE2_AXI_S_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 12, 0, 0, 0},
	{GCC_PCIE2_RCHNG_CMD_RCGR, GCC_PCIE2_RCHNG_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},
	{GCC_PCIE3_AXI_M_CMD_RCGR, GCC_PCIE3_AXI_M_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 9, 0, 0, 0},
	{GCC_PCIE3_AXI_S_CMD_RCGR, GCC_PCIE3_AXI_S_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 12, 0, 0, 0},
	{GCC_PCIE3_RCHNG_CMD_RCGR, GCC_PCIE3_RCHNG_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},
	{GCC_PCIE4_AXI_M_CMD_RCGR, GCC_PCIE4_AXI_M_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 12, 0, 0, 0},
	{GCC_PCIE4_AXI_S_CMD_RCGR, GCC_PCIE4_AXI_S_CFG_RCGR, 0, 0, 0, SRC_GPLL4, 12, 0, 0, 0},
	{GCC_PCIE4_RCHNG_CMD_RCGR, GCC_PCIE4_RCHNG_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},

	/* USB Clocks */
	{GCC_USB0_MASTER_CMD_RCGR, GCC_USB0_MASTER_CFG_RCGR,
	 GCC_USB0_MASTER_M, GCC_USB0_MASTER_N, GCC_USB0_MASTER_D,
	 SRC_GPLL0, 8, 0, 0, 0},
	{GCC_USB0_AUX_CMD_RCGR, GCC_USB0_AUX_CFG_RCGR,
	 GCC_USB0_AUX_M, GCC_USB0_AUX_N, GCC_USB0_AUX_D, SRC_XO, 2, 0, 0, 0},
	{GCC_USB0_MOCK_UTMI_CMD_RCGR, GCC_USB0_MOCK_UTMI_CFG_RCGR,
	 GCC_USB0_MOCK_UTMI_M, GCC_USB0_MOCK_UTMI_N, GCC_USB0_MOCK_UTMI_D,
	 SRC_GPLL4_USB, 20, 1, 2, 4},
	{GCC_USB1_MOCK_UTMI_CMD_RCGR, GCC_USB1_MOCK_UTMI_CFG_RCGR,
	 GCC_USB1_MOCK_UTMI_M, GCC_USB1_MOCK_UTMI_N, GCC_USB1_MOCK_UTMI_D,
	 SRC_GPLL4_USB, 20, 1, 2, 4},

	/* QDSS Clocks */
	{GCC_QDSS_AT_CMD_RCGR, GCC_QDSS_AT_CFG_RCGR, 0, 0, 0, SRC_GPLL4_QDSS, 10, 0, 0, 0},
	{GCC_QDSS_STM_CMD_RCGR, GCC_QDSS_STM_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 8, 0, 0, 0},
	{GCC_QDSS_TRACECLKIN_CMD_RCGR, GCC_QDSS_TRACECLKIN_CFG_RCGR,
	 0, 0, 0, SRC_GPLL4_QDSS, 8, 0, 0, 0},
	{GCC_QDSS_TSCTR_CMD_RCGR, GCC_QDSS_TSCTR_CFG_RCGR, 0, 0, 0, SRC_GPLL4_QDSS, 4, 0, 0, 0},

	/* NOC Clocks */
	{GCC_SYSTEM_NOC_BFDCD_CMD_RCGR, GCC_SYSTEM_NOC_BFDCD_CFG_RCGR,
	 0, 0, 0, SRC_GPLL4, 9, 0, 0, 0},
	{GCC_PCNOC_BFDCD_CMD_RCGR, GCC_PCNOC_BFDCD_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},
	{GCC_ANOC0_AXI_BFDCD_CMD_RCGR, GCC_ANOC0_AXI_BFDCD_CFG_RCGR,
	 0, 0, 0, SRC_GPLL4, 7, 0, 0, 0},
	{GCC_GEMNOC_ANOC_PCIE_CMD_RCGR, GCC_GEMNOC_ANOC_PCIE_CFG_RCGR,
	 0, 0, 0, SRC_GPLL0, 8, 0, 0, 0},

	/* QPIC Clocks */
	{GCC_QPIC_CMD_RCGR, GCC_QPIC_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},
	{GCC_QPIC_IO_MACRO_CMD_RCGR, GCC_QPIC_IO_MACRO_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 8, 0, 0, 0},

	/* SDCC Clocks */
	{GCC_SDCC1_APPS_CMD_RCGR, GCC_SDCC1_APPS_CFG_RCGR,
	 GCC_SDCC1_APPS_M, GCC_SDCC1_APPS_N, GCC_SDCC1_APPS_D,
	 SRC_GPLL0, 8, 0, 0, 0},
	{GCC_SDCC1_ICE_CORE_CMD_RCGR, GCC_SDCC1_ICE_CORE_CFG_RCGR,
	 GCC_SDCC1_ICE_CORE_M, GCC_SDCC1_ICE_CORE_N, GCC_SDCC1_ICE_CORE_D,
	 SRC_GPLL4, 8, 0, 0, 0},

	/* Other Clocks */
	{GCC_XO_CMD_RCGR, GCC_XO_CFG_RCGR, 0, 0, 0, SRC_XO, 2, 0, 0, 0},
	{GCC_SLEEP_CMD_RCGR, GCC_SLEEP_CFG_RCGR, 0, 0, 0, SRC_XO, 2, 0, 0, 0},
	{GCC_NSS_TS_CMD_RCGR, GCC_NSS_TS_CFG_RCGR, 0, 0, 0, SRC_XO, 2, 0, 0, 0},
	{GCC_NSSNOC_MEMNOC_BFDCD_CMD_RCGR, GCC_NSSNOC_MEMNOC_BFDCD_CFG_RCGR,
	 0, 0, 0, SRC_NSS_CMN_CLK, 2, 0, 0, 0},
	{GCC_UNIPHY_SYS_CMD_RCGR, GCC_UNIPHY_SYS_CFG_RCGR, 0, 0, 0, SRC_XO, 2, 0, 0, 0},
	{GCC_RBCPR_CMD_RCGR, GCC_RBCPR_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 32, 0, 0, 0},
	{GCC_DDRSS_SMS_SLOW_CMD_RCGR, GCC_DDRSS_SMS_SLOW_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 20, 0, 0, 0},
	{GCC_ADSS_PWM_CMD_RCGR, GCC_ADSS_PWM_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},
	{GCC_APC0_VOLTAGE_DROOP_DETECTOR_CMD_RCGR,
	 GCC_APC0_VOLTAGE_DROOP_DETECTOR_CFG_RCGR,
	...
	{GCC_PRIMESS_CMD_RCGR, GCC_PRIMESS_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 2, 0, 0, 0},
	/* gcc_primess_axim_clk_src: GPLL0 (800MHz) / 4 = 200MHz */
	{GCC_PRIMESS_AXIM_CMD_RCGR, GCC_PRIMESS_AXIM_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 8, 0, 0, 0},
	/* gcc_primess_ahbm_clk_src: GPLL0 (800MHz) / 8 = 100MHz */
	{GCC_PRIMESS_AHBM_CMD_RCGR, GCC_PRIMESS_AHBM_CFG_RCGR, 0, 0, 0, SRC_GPLL0, 16, 0, 0, 0},

	/* TuringSS Clocks */
	/* gcc_turing_epcb_rx_clk_src: XO (24MHz) / 1 = 24MHz */
	{GCC_TURING_EPCB_RX_CMD_RCGR, GCC_TURING_EPCB_RX_CFG_RCGR, 0, 0, 0, SRC_XO, 2, 0, 0, 0},
	/* gcc_turing_q6_axim_bfdcd_clk_src: GPLL4 (1200MHz) / 3.5 = 342.857MHz */
	{GCC_TURING_Q6_AXIM_BFDCD_CMD_RCGR, GCC_TURING_Q6_AXIM_BFDCD_CFG_RCGR,
	 0, 0, 0, SRC_GPLL4, 7, 0, 0, 0},
};
#endif /* CONFIG_TARGET_IPQ9650 */
...
void ipq_enable_all_clks(void)
{
	...
	uint32_t cbcr_val;
	uintptr_t cbcr_reg;
	const unsigned long *ena_vote_clocks;
	const unsigned long *cbcr_clocks;
	const rcgr_config_entry_t *rcgr_configs;
	size_t ena_vote_count, cbcr_count, rcgr_count;

#ifdef ENABLE_PLL_CONFIG
	/* Step 1: Enable all PLLs */
	ret = hermosa_gcc_enable_plls();
	if (ret != HERMOSA_GCC_SUCCESS)
		printf("PLL clock enable failed.\n");
#endif

	/* Select clock arrays based on target */
#if defined(CONFIG_TARGET_IPQ9650)
	ena_vote_clocks = ipq9650_ena_vote_clocks;
	ena_vote_count = ARRAY_SIZE(ipq9650_ena_vote_clocks);
	cbcr_clocks = ipq9650_all_cbcr_clocks;
	cbcr_count = ARRAY_SIZE(ipq9650_all_cbcr_clocks);
	rcgr_configs = ipq9650_rcgr_configs;
	rcgr_count = ARRAY_SIZE(ipq9650_rcgr_configs);
	printf("Configuring clocks for IPQ9650 (Juhu)\n");
#else /* CONFIG_TARGET_IPQ5210 */
	ena_vote_clocks = ipq5210_ena_vote_clocks;
	ena_vote_count = ARRAY_SIZE(ipq5210_ena_vote_clocks);
	cbcr_clocks = ipq5210_all_cbcr_clocks;
	cbcr_count = ARRAY_SIZE(ipq5210_all_cbcr_clocks);
	rcgr_configs = ipq5210_rcgr_configs;
	rcgr_count = ARRAY_SIZE(ipq5210_rcgr_configs);
	printf("Configuring clocks for IPQ5210\n");
#endif

	/* Enable vote clocks */
	for (size_t i = 0; i < ena_vote_count; i++)
		writel(0xFFFFFFFF, (void *)ena_vote_clocks[i]);

	/* Step 2: Configure all RCGRs */
	for (size_t i = 0; i < rcgr_count; i++) {
		pr_debug("enabling RCGR 0x%08lx\n", rcgr_configs[i].cmd_rcgr);
		ret = hermosa_gcc_configure_rcgr_entry(&rcgr_configs[i]);
		if (ret != 0) {
			printf("failed to enabled RCGR 0x%08lx\n", rcgr_configs[i].cmd_rcgr);
	...
	for (size_t i = 0; i < cbcr_count; i++) {

		cbcr_reg = cbcr_clocks[i];

		/* Check if already enabled */
		cbcr_val = readl(cbcr_reg);
		if (!(cbcr_val & CBCR_CLK_OFF)) {
			pr_debug("clock 0x%08lx already enabled\n", cbcr_reg);
			continue;
		}
		...
		while (timeout-- > 0) {
			cbcr_val = readl(cbcr_reg);
			if (!(cbcr_val & CBCR_CLK_OFF)) {
				pr_debug("clock 0x%08lx enabled\n", cbcr_reg);
				break;
			}
			udelay(1);
		}
		if (cbcr_val & CBCR_CLK_OFF)
			printf("clock 0x%08lx failed to enable\n", cbcr_reg);
	}
}
